...
contract DemoWarmWallet {
    ...
    // keccak256("DemoWarmWallet")
    bytes32 constant NAME_HASH = 0x24166028344b4060d4adbdb048fa400006670bca8177f345828282f544d820cd;
    // keccak256("1")
    bytes32 constant VERSION_HASH = 0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6;
    // keccak256("DemoWarmWalletTransaction(address destination,uint256 value,bytes data,uint256 nonce,address executor,uint256 gasLimit)")
    bytes32 constant TXTYPE_HASH = 0xbeb1ba6b4602d04496df8c27075b428447e4f4b8a91e22bfa27000743d4f20b7;
    ...
    constructor(address _admin, address _member, uint _transactionLimit, uint _dailyLimit, uint chainId) {
